...
LOG_FILE = os.path.join(TASK03_DIR, "prediction_report.txt")
...
# Save predictions to CSV file at artifacts/task03/predictions.csv
...
def prepare_prediction_dataloader(predict_path=PREDICT_DIR):
    ...
    dataset = AugmentedImageDataset(df)
...
def main():
    ...
    # 3. Write artifacts/task03/predictions.csv (columns: row_id, predicted_label)
